/**
 * I have an idea what this component was originally supposed to do, but seeing as I wanted to handle
 * multiple output types, this was not used. Maybe it could be used for something else, but for now,
 * it is not used.
 */
