  ...
  return (
    <div>
      ...
      <section className="jumbotron text-center">
        <div className="container">
          ...
          <div className="flex-container">
            <div className="flex-child left">
              <div className="techText"><h3><span className="dot blueDot"></span>&nbsp;&nbsp;Our Technology</h3></div>
              <p className="lead text-muted"><h3>NeRF consists of a website that
      ...
      <div className="beigeDiv">
        <div>
          <div className="techText"><h2><span className="dot aquaDot"></span>&nbsp;&nbsp;How Does It Work?</h2></div>
          <div className="miniPoints">
            <h2><span className="dot aquaDot"></span>&nbsp;&nbsp;Uploaded video gets sent to our database</h2>
            <h2><span className="dot aquaDot"></span>&nbsp;&nbsp;Flask server sends video to RabbitMQ
              for video processing</h2>
            <h2><span className="dot aquaDot"></span>&nbsp;&nbsp;Video processed for 10-15 minutes</h2>
            <h2><span className="dot aquaDot"></span>&nbsp;&nbsp;Our NeRF worker receives the processed
        ...
        <div>
          <div className="techText"><h2><span className="dot orangeDot"></span>&nbsp;&nbsp;Back-End Structure and Framework</h2></div>
          <div className="miniPoints">
            <h2><span className="dot orangeDot"></span>&nbsp;&nbsp;NerF is a neural network that generates
              novel views of complex 3D scenes with 2d
              images and their coordinates</h2>
            <h2><span className="dot orangeDot"></span>&nbsp;&nbsp;We take input images representing a
              scene and interpolating between them
              to render one complete scene</h2>
            <h2><span className="dot orangeDot"></span>&nbsp;&nbsp;NeRF uses a sparse set of input views to
              optimize a continuous volumetric scene
              function</h2>
            <h2><span className="dot orangeDot"></span>&nbsp;&nbsp;The result of this optimization is the ability
        ...
        <div>
          <div className="techText"><h2><span className="dot pinkDot"></span>&nbsp;&nbsp;Webserver Structure and Framework</h2></div>

          <div className="miniPoints">
            <h2><span className="dot pinkDot"></span>&nbsp;&nbsp;Flask web server serves as a connection
              point that manages messages transmitting
              between the frontend and the backend</h2>
            <h2><span className="dot pinkDot"></span>&nbsp;&nbsp;MongoDB is a asynchronous messenger
              that hoses the structure for motion queue
              and NerF queue for backend video
              processing.</h2>
            <h2><span className="dot pinkDot"></span>&nbsp;&nbsp;MongoDB database servers as a place to
